        ...
        success : function(data){
            ...
            for(let i = 0; i<dt.length; i++){
                ...
                switch(i){
                  case 0:
                    ...
                    airInfo +=`<div class="col-6 aqi">
                                <span>대기질<h3>${st[parseInt(data.list[0].main.aqi)-1]}</h3></span>             
                              </div>
                              <div class="col-6 humi">
                                  <span>습도<h3>${dt[0].main.humidity}%</h3></span>   
                              </div>`;

                    sunInfo += `<div class="col-6 rise">
                ...
                dayBox += `<div class="day-content">
                            ...
                            <div class="wind">${dt[i].wind.speed}m/s</div>
                            <div class="day-temp">
                              ${Math.round(dt[i].main.temp)}º
                            </div>
            ...
            $('.timebox').html(timeBox);
            $('.daybox').html(dayBox);
            $('.sun-info').html(sunInfo);
            // applySlider();
